                            ...
                            <div class="col-xxl-7">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{ url('/update_testimonial')}}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="firstNameinput" class="form-label">First Name<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" placeholder="Enter your firstname" name="fname" value="{{ $view_testi[0]->fname }}">
                                                        <input type="hidden" name="id" id="id" value="<?= @$view_testi[0]->id ?>">
                                                        <input type="hidden" name="oldimage" value="<?=@$view_testi[0]->image?>">
                                                        @if ($errors->has('fname'))
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter your lastname" name="lname" value="<?= @$view_testi[0]->lname ?>">
                                                        @if ($errors->has('lname'))
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Enter designation" name="designation" value="<?= @$view_testi[0]->designation ?>">
                                ...
                                @if(@$view_testi[0]->image !='')                                
                                    <div class="upload-image">
                                    <img id="imgPreview" name="imgPreview" class="img-fluid" src="{{ url('public/admin/assets/storeImages/testimonials/' . @$view_testi[0]->image) }}" value="{{@$view_testi[0]->image}}" style="width:150px;height:150px;">
                                    </div> 
                                @endif  
                                </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" name="status">
                                                            <option {{(@$view_testi[0]->status == '1'?'selected':'')}} value="1">Active</option>
                                                            <option {{(@$view_testi[0]->status == '0'?'selected':'')}} value="0">Inactive</option>
                                                        </select>
