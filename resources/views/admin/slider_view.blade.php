                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    <div class="row align-items-center gy-3">
                                        ...
                                        <div class="col-md-auto col-6 text-end">
                                            <div class="d-flex flex-wrap align-items-start gap-2">
                                               ...
                                               <a href="{{ url('/slider')}}"> <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#addAgent"><i class="bi bi-person-plus align-baseline me-1"></i> Add Slider</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    @endif
                                        <table class="table table-bordered dt-responsive table-striped align-middle" id="slider_list">
                                            <thead>
                                                <tr>   
                                                    <th>SR No.</th>
                                                    <th>Image</th>
