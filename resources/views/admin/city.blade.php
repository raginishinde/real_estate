                            ...
                            <div class="col-xxl-7">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Create City</h4>
                                    </div><!-- end card header -->

                                    <div class="card-body">
                                       
                                    
                                        <form method="post" action="{{ url('/create_city')}}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="phonenumberInput" class="form-label">Image<span class="text-danger">*</span></label>
