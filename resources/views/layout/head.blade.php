 <head>
      ...
      <link rel="stylesheet" href="{{ asset('public/css/ud-custom-spacing.css') }}">
      ...
      <link href="{{ asset('public/images/apple-touch-icon-180x180.png') }}" sizes="180x180" rel="apple-touch-icon">
