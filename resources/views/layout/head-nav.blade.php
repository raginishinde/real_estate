                  ...
                  <div class="row align-items-center justify-content-between">
                     <div class="col-auto pe-0">
                        <div class="d-flex align-items-center justify-content-between">
                           <div class="logos mr10">
                              <a class="header-logo logo1" href="{{ url('/')}}"><img src="{{ asset('public/images/header-logo.svg') }}" alt="Header Logo"></a>
                              <a class="header-logo logo2" href="{{ url('/')}}"><img src="{{ asset('public/images/header-logo2.svg') }}" alt="Header Logo"></a>
                           </div>
                           <!-- Responsive Menu Structure-->
                           <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal" style="margin-left: 175px;">
                              <li class="visible_list"> <a class="list-item" href="{{ url('/')}}"><span class="title">Home</span></a>
                              </li>
                              <li class="megamenu_style"> <a  class="list-item" href="{{ url('/about')}}"><span class="title">About Us </span></a>
                              </li>
                              <li class="visible_list"> <a class="list-item" href="{{ url('/project')}}"><span class="title">Projects</span></a>
                              </li>
                              <li class="visible_list"> <a class="list-item" href="#"><span class="title">Gallery</span></a>
                              </li>
                              <li class="visible_list"> <a class="list-item" href="{{ url('/contact')}}"><span class="title">Reach Us</span></a>
                              </li>
                           </ul>
                        </div>
                     </div>
                     <div class="col-auto">
                        <div class="d-flex align-items-center">
                           <a class="login-info d-flex align-items-center" data-bs-toggle="modal" href="#exampleModalToggle" role="button" style="    margin-right: 25px;"><i class="far fa-user-circle fz16 me-2"></i> <span class="d-none d-xl-block">Login / Register</span></a>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="header innerpage-style">
                  <div class="menu_and_widgets">
                     <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
                        <a class="menubar" href="#menu"><img src="{{ asset('public/images/mobile-dark-nav-icon.svg') }}" alt=""></a>
                        <a class="mobile_logo" href="#"><img src="{{ asset('public/images/header-logo2.svg') }}" alt=""></a>
